/*
FileName:		USB_Keyboard01.c
This file has been modified (simplifed) and renamed.
It is based on the Microchip Technology Incorporated file
Keyboard.c that can be obtained from the web from
http://www.microchip.com/stellent/idcplg?IdcService=SS_GET_PAGE&nodeId=1406&dDocName=en536385
the download is called Low Pin-Count USB Development Kit Project Labs  
When the file is uncompressed the Keyboard.c file can be found in
the folder \LPCUSBDK_Labs_V3\Lab3_files
The copyright notice below has been retained in this altered file to comply with
Microchip's copyright intentions. It is my intention (Dan Peirce) as 
a customer to use this on the Microchip Low Pin-Count USB Development Kit
board for educational purpose.

File last modified on July 29, 2011 by Dan Peirce
...
/** CONFIGURATION **************************************************/
//(LOW_PIN_COUNT_USB_DEVELOPMENT_KIT)
